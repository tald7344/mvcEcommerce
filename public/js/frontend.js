$(function () {
	...
	$('.side_nav').css('right', 0); // For Show the Side Bar
	$('.contents').css('margin-right', side_nav_widht); // For Compatible The Content With Side Bar			
	...
	$('header.topbar .fa-bars').click(function () {
		if ($(this).hasClass('fa-rotate-90')) {
			...
			$('.side_nav').css('right', '-' + side_nav_widht + 'px');
			$('.contents').css('margin-right', 0);
		} else {
			$(this).addClass('fa-rotate-90');
			$('.side_nav').css('right', 0);
			$('.contents').css('margin-right', side_nav_widht);			
		}
	});
